...
if (pageName == 'about.html') {
  ...
  localSBtn = document.querySelector('.subbtn')
  ...
  localSBtn.onclick = function () {
    singleProductOb.name = inputName.value;
    singleProductOb.email = inputEmail.value;
    singleProductOb.password = inputPass.value;

    localStorage.setItem('single', JSON.stringify(singleProductOb))
  }
}

const competitionTableUrl =
  (phaseId, langId) => `https://sportapi.widgets.sports.gracenote.com/football/gettable/phaseid/${phaseId}/languagecode/${langId}.json?c=115&module=football&type=standing`,
